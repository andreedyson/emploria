...
import ViewLeaveDialog from "../../admin/leave/view-leave-dialog";
import ApproveRejectLeaveDialog from "../../admin/leave/approve-reject-leave-dialog";

export const DepartmentLeaveColumns: ColumnDef<LeaveColumnProps>[] = [
  {
    id: "name",
